...
def json_to_md(filename, md_filename, task="", to_web=False, use_title=True, use_tc=True, show_badge=True):
    ...
    with open(md_filename, "a+", encoding='utf-8') as f:
        ...
        if use_title is True:
            # f.write(("<p align="center"><h1 align="center"><br><ins>nlp-ARXIV-DAILY"
            #         "</ins><br>Automatically Update nlp Papers Daily</h1></p>\n"))
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--update_paper_links", default=False, action="store_true", help="whether to update paper links etc."
    )
